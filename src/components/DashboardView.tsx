    ...
    <div className="flex-1 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <button
          ...
          className="group text-left relative bg-white border border-outline-variant rounded-xl p-8 overflow-hidden hover:border-tertiary transition-all duration-300 shadow-sm hover:shadow-md flex flex-col justify-between min-h-[210px] cursor-pointer outline-none select-none"
        >
        ...
        <button
          ...
          className="group text-left relative bg-white border border-outline-variant rounded-xl p-8 overflow-hidden hover:border-primary transition-all duration-300 shadow-sm hover:shadow-md flex flex-col justify-between min-h-[210px] cursor-pointer outline-none select-none"
        >
          ...
          <div>
            ...
            <h3 className="text-xl font-bold font-headline-sm text-on-surface mb-2 group-hover:text-primary transition-colors">
              Reparaciones
            </h3>
            <p className="text-xs font-sans text-on-surface-variant leading-relaxed font-medium">
        ...
        <button
          onClick={onLogout}
          className="group relative bg-white border border-dashed border-slate-300 rounded-xl p-8 overflow-hidden hover:bg-error-container hover:border-error transition-all duration-300 flex items-center justify-center min-h-[210px] cursor-pointer outline-none select-none"
        >
